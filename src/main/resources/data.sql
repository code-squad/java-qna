...
INSERT INTO COMMENT (comment_id, contents, created_date_time, question_id_fk, user_id_fk, deleted)
    VALUES (1, 'Auto Inserted Comments - First', '2018-12-02 20:47:28.685', 1, 2, 0);
INSERT INTO COMMENT (comment_id, contents, created_date_time, question_id_fk, user_id_fk, deleted)
    VALUES (2, 'Auto Inserted Comments - Second', '2018-12-02 20:48:28.685', 1, 1, 0);
