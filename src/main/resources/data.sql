...
INSERT INTO QUESTION (id, created_time, contents, title,count_of_answer, writer_id) VALUES (1, CURRENT_TIMESTAMP, '테스트 질문입니다', 'guest의 테스트 질문', 4 ,2);
INSERT INTO QUESTION (id, created_time, contents, title,count_of_answer, writer_id) VALUES (2, CURRENT_TIMESTAMP, '마스터의 테스트 질문', 'master 테스트 질문2',0, 1);
