...
INSERT INTO QUESTION (TITLE, CONTENTS, WRITER_ID) VALUES ('사람은 무엇으로 사는가?', '톨스토이가 씀', '1');
INSERT INTO QUESTION (TITLE, CONTENTS, WRITER_ID) VALUES ('사람은 무엇으로 성장하는가?', '존 맥스웰이 씀', '2');
